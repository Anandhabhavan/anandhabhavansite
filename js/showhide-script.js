...
$(".signup_form").show();
$(".signin_form,.forget_pw_form,.forget_pw_otp_form,.new_pw_form,.thankyou_form").hide();
});

$(".signin").click(function(){
$(".signin_form").show();
$(".signup_form,.forget_pw_form,.forget_pw_otp_form,.new_pw_form,.thankyou_form").hide();
});

$(".forget_pw").click(function(){
$(".forget_pw_form").show();
$(".signin_form,.signup_form,.forget_pw_otp_form,.new_pw_form,.thankyou_form").hide();
});

$(".fpw_sub_btn").click(function(){
$(".forget_pw_otp_form").show();
$(".signin_form,.signup_form,.forget_pw_form,.new_pw_form,.thankyou_form").hide();
});

$(".sub_otp_btn").click(function(){
$(".new_pw_form").show();
$(".signin_form,.signup_form,.forget_pw_form,.forget_pw_otp_form,.thankyou_form").hide();
});

$(".new_pw_subbtn").click(function(){
$(".thankyou_form").show();
$(".signin_form,.signup_form,.forget_pw_form,.forget_pw_otp_form,.new_pw_form").hide();
});
